  ...
  render() {
    return(
      <div className="SingleAnimeFavorites">
        ...
        <div className="links"><Link to={`/favorites/manga/${this.props.match.params.dbid}/${this.props.match.params.apiid}/edit`}>Edit</Link></div>
        {this.state.singleAnime ? <img className="cover-image" alt="" src={this.state.singleAnime.attributes.coverImage.original} /> : ""}
