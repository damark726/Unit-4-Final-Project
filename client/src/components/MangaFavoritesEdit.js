...
//=====================================================================================================================================
componentDidMount() {
  axios.get(`/favorites/${this.props.match.params.dbid}`)
  .then(data =>{
...
//=====================================================================================================================================
  deleteManga() {
    axios.delete(`/favorites/${this.props.match.params.dbid}`)
    .then(res => {
      this.setState({
        fireRedirect:true
      })
      ...
      <div className="MangaFavoriteEdit">
        <div id="edit">Edit Entry</div>
          <form onSubmit={this.handleFormSubmit}>
            ...
            <br />
            <input type="submit" className="delete" onClick={this.deleteManga} value="Delete"/>
          </form>
